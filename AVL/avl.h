...
void balanceamento(avl *arv, no *noDesbal, int tipo);
...
//Função para imprimir o tempo e o numero de rotações de inserção e remoção
void imprimeMetricas();

//Função para buscar o nó dentro da árvore
